...
sudo apt-get -y update && sudo apt-get -y upgrade && sudo apt-get install build-essential && sudo apt-get -y install git g++ imagemagick xclip libsdl1.2-dev libglu1-mesa-dev libgl1-mesa-dev make
